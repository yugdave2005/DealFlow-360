                  ...
                  return (
                    <tr key={inv.id} className="hover:bg-[#FAF8F5]/70 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        {inv.status === 'PAID' ? (
                          <span className="text-xs font-semibold text-emerald-700 inline-flex items-center justify-end gap-1">
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-[#B85D19] hover:bg-[#9E4E13] text-white font-semibold text-xs rounded-xl shadow-xs transition-colors cursor-pointer"
                          >
                            Record Payment
                          </button>
                        )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1E1B18]/40 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-[#FFFFFF] w-full max-w-md rounded-2xl shadow-xl border border-[#EBE8E2] p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="block font-semibold text-[#44403C] mb-1">Payment Method</label>
                <select
                  value={paymentMethod}
