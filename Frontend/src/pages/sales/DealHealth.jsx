          ...
          <div className="space-y-3">
            {stalledDeals.length === 0 ? (
              ...
              <div key={deal.id} className="p-4 bg-[#FAF9F6] rounded-[10px] border border-[#E6E1D9] hover:border-[#D8D1C8] transition-colors">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-[#E6E1D9]/60 text-xs">
                  <button
                    onClick={() => escalateMutation.mutate({ itemId: deal.id, type: 'Stalled Deal', notes: 'Urgent: Deal has completely stalled.' })}
                    className="text-[#C95757] hover:text-[#B54646] font-bold flex items-center gap-1 bg-[#FBEAEA] px-2 py-1 rounded cursor-pointer transition-colors"
                ...
                <div className="flex items-center justify-between pt-1 text-xs">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="text-[#C95757] hover:text-[#B54646] font-bold flex items-center gap-1 cursor-pointer transition-colors"
                      disabled={escalateMutation.isPending}
                    >
